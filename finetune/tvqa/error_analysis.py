...
from finetune.common_dataloader_knowledge import finetune_input_fn_builder, finetune_val_input_fn_builder
...
def val_epoch(state: train_state.TrainState):
    ...
    text_preds.to_csv('comknownew_text_preds_error.csv')
    audio_preds.to_csv('comknownew_audio_preds_error.csv')
    joint_preds.to_csv('comknownew_joint_preds_error.csv')
